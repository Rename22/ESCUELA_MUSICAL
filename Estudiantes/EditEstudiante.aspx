<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEstudiante.aspx.cs" Inherits="Proyecto_FInal_Escuela_Musica.Estudiantes.EditEstudiante" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-actions">
                    <asp:Button ID="btnActualizar" runat="server" Text="Actualizar" OnClick="btnActualizar_Click" CssClass="btn btn-primary btn-lg px-4 me-2" />
                    <a href="ListEstudiantes.aspx" class="btn btn-secondary btn-lg px-4">Volver</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var redirect = document.getElementById('<%= hdnRedirect.ClientID %>').value;
