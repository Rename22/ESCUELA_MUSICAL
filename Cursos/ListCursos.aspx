<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ListCursos.aspx.cs" Inherits="Proyecto_FInal_Escuela_Musica.Cursos.ListCursos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="header-actions">
                    <a href="AddCurso.aspx" class="btn btn-success btn-icon">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="input-group">
                                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control" placeholder="Buscar por nombre, descripción o nivel..." />
                ...
                <div class="table-container">
                    <asp:GridView ID="gvCursos" runat="server" AutoGenerateColumns="False" 
                        ...
                        DataKeyNames="id_cur" PagerStyle-CssClass="pagination" 
                        HeaderStyle-CssClass="thead-dark" ShowHeaderWhenEmpty="true">
                        <Columns>
                            <asp:BoundField DataField="nombre_cur" HeaderText="Nombre" />
                            <asp:BoundField DataField="descripcion_cur" HeaderText="Descripción" />
                            <asp:BoundField DataField="nivel_cur" HeaderText="Nivel" />
                            <asp:BoundField DataField="duracion_semanas_cur" HeaderText="Duración (semanas)" />
                            <asp:BoundField DataField="costo_total_cur" HeaderText="Costo Total" DataFormatString="{0:C}" />
                            <asp:BoundField DataField="nombre_prof" HeaderText="Profesor" />
                            <asp:TemplateField HeaderText="Acciones" HeaderStyle-CssClass="actions-column" ItemStyle-CssClass="actions-column">
                                <ItemTemplate>
                                    <div class="action-buttons">
                                        <asp:HyperLink runat="server" NavigateUrl='<%# "EditCurso.aspx?id=" + Eval("id_cur") %>' 
                                            CssClass="btn btn-sm btn-warning" ToolTip="Editar">
                                            <i class="fas fa-edit"></i>
                                        </asp:HyperLink>
                                        <button type="button" class="btn btn-sm btn-danger" 
                                            title="Eliminar"
                                            onclick="confirmarEliminacionCurso(<%# Eval("id_cur") %>, '<%# Eval("nombre_cur") %>')">
                        ...
                        <EmptyDataTemplate>
                            <div class="empty-state">
                                ...
                                <a href="AddCurso.aspx" class="btn btn-primary mt-3">
                                    <i class="fas fa-plus"></i> Agregar Curso
                                </a>
                            </div>
                        </EmptyDataTemplate>
    ...
    <!-- Formulario oculto para eliminar cursos -->
    <asp:Button ID="btnEliminarCurso" runat="server" OnClick="btnEliminarCurso_Click" style="display: none;" />
    <asp:HiddenField ID="hdnCursoAEliminar" runat="server" />
    ...
    <script>
        ...
        function confirmarEliminacionCurso(idCurso, nombreCurso) {
            iziToast.question({
                ...
                displayMode: 'once',
                title: '¿Estás seguro?',
                message: `Esta acción eliminará permanentemente el curso:<br><strong>${nombreCurso}</strong>`,
                position: 'center',
                buttons: [
                    ['<button><b>Sí, eliminar</b></button>', function (instance, toast) {
                        instance.hide({}, toast);
                        
                        // Guardar el ID del curso a eliminar en el campo oculto
                        document.getElementById('<%= hdnCursoAEliminar.ClientID %>').value = idCurso;
                        
                        // Disparar el evento de eliminación
                        document.getElementById('<%= btnEliminarCurso.ClientID %>').click();
                    }, true],
