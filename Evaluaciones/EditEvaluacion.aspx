<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEvaluacion.aspx.cs" Inherits="Proyecto_FInal_Escuela_Musica.Evaluaciones.EditEvaluacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Editar Evaluación</h3>
            </div>
            
            <div class="card-body">
                <asp:HiddenField ID="hdnMensaje" runat="server" />
                <asp:HiddenField ID="hdnIdEvaluacion" runat="server" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlEstudiante" runat="server" CssClass="form-control">
                                    <asp:ListItem Text="Seleccione un estudiante" Value="" />
                                </asp:DropDownList>
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlCurso" runat="server" CssClass="form-control">
                                    <asp:ListItem Text="Seleccione un curso" Value="" />
                                </asp:DropDownList>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtPuntuacion" runat="server" CssClass="form-control" TextMode="Number" step="0.01" min="0" max="10" />
                            </div>
                ...
                <div class="form-actions">
                    <asp:Button ID="btnActualizar" runat="server" Text="Actualizar" 
                        OnClick="btnActualizar_Click" CssClass="btn btn-primary btn-lg px-4 me-2" />
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#<%= btnActualizar.ClientID %>").click(function (e) {
                let valido = true;
                ...
                valido &= validarNumero("#<%= txtPuntuacion.ClientID %>", "#errorPuntuacion", 0, 10, "Puntuación debe ser entre 0 y 10");
            ...
            $("#<%= txtPuntuacion.ClientID %>").on("change blur", function () {
                validarNumero(this, "#errorPuntuacion", 0, 10, "Puntuación debe ser entre 0 y 10");
            });
