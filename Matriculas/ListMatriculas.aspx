<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ListMatriculas.aspx.cs" Inherits="Proyecto_FInal_Escuela_Musica.Matriculas.ListMatriculas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="header-actions">
                    <a href="AddMatricula.aspx" class="btn btn-success btn-icon">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="input-group">
                                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control" placeholder="Buscar por estudiante, curso..." />
                ...
                <div class="table-container">
                    <asp:GridView ID="gvMatriculas" runat="server" AutoGenerateColumns="False" 
                        ...
                        DataKeyNames="id_mat" PagerStyle-CssClass="pagination" 
                        HeaderStyle-CssClass="thead-dark" ShowHeaderWhenEmpty="true">
                        <Columns>
                            <asp:BoundField DataField="id_mat" HeaderText="ID" Visible="true" />
                            <asp:TemplateField HeaderText="Estudiante">
                                <ItemTemplate>
                                    <%# Eval("nombre_estu") + " " + Eval("apellido_estu") %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="fecha_matricula_mat" HeaderText="Fecha Matrícula" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="fecha_inicio_mat" HeaderText="Fecha Inicio" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="fecha_fin_mat" HeaderText="Fecha Fin" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:TemplateField HeaderText="Acciones" HeaderStyle-CssClass="actions-column" ItemStyle-CssClass="actions-column">
                                <ItemTemplate>
                                    <div class="action-buttons">
                                        <asp:HyperLink runat="server" NavigateUrl='<%# "EditMatricula.aspx?id=" + Eval("id_mat") %>' 
                                            CssClass="btn btn-sm btn-warning" ToolTip="Editar">
                                            <i class="fas fa-edit"></i>
                                        </asp:HyperLink>
                                        <button type="button" class="btn btn-sm btn-danger" 
                                            title="Eliminar"
                                            onclick="confirmarEliminacionMatricula(<%# Eval("id_mat") %>, '<%# Eval("nombre_estu") %>')">
                        ...
                        <EmptyDataTemplate>
                            <div class="empty-state">
                                ...
                                <p class="mb-0">No hay matrículas registradas en el sistema</p>
                                <a href="AddMatricula.aspx" class="btn btn-primary mt-3">
                                    <i class="fas fa-plus"></i> Nueva Matrícula
                                </a>
                            </div>
                        </EmptyDataTemplate>
    ...
    <!-- Formulario oculto para eliminar matrículas -->
    <asp:Button ID="btnEliminarMatricula" runat="server" OnClick="btnEliminarMatricula_Click" style="display: none;" />
    <asp:HiddenField ID="hdnMatriculaAEliminar" runat="server" />
    ...
    <script>
        ...
        function confirmarEliminacionMatricula(idMatricula, nombreEstudiante) {
            iziToast.question({
                timeout: false,
                close: false,
                overlay: true,
                displayMode: 'once',
                title: '¿Estás seguro?',
                message: `Esta acción eliminará permanentemente la matrícula de:<br><strong>${nombreEstudiante}</strong>`,
                position: 'center',
                buttons: [
                    ['<button><b>Sí, eliminar</b></button>', function (instance, toast) {
                        instance.hide({}, toast);
                        
                        // Guardar el ID de la matrícula a eliminar en el campo oculto
                        document.getElementById('<%= hdnMatriculaAEliminar.ClientID %>').value = idMatricula;
                        
                        // Disparar el evento de eliminación
                        document.getElementById('<%= btnEliminarMatricula.ClientID %>').click();
                    }, true],
