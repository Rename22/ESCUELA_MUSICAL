<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditProfesor.aspx.cs" Inherits="Proyecto_FInal_Escuela_Musica.Profesores.EditProfesor" %>
        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlEspecialidad" runat="server" CssClass="form-control">
                                    <asp:ListItem Text="Seleccione una especialidad" Value="" Selected="True" />
                                </asp:DropDownList>
                            </div>
                            <small id="errorEspecialidad" class="error-message d-none"></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="ListProfesores.aspx" class="btn btn-secondary btn-lg px-4">Cancelar</a>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#<%= btnActualizar.ClientID %>").click(function (e) {
                ...
                // Validar especialidad (select)
                valido &= validarSelect("#<%= ddlEspecialidad.ClientID %>", "#errorEspecialidad", "Seleccione una especialidad.");
            ...
            $("#<%= ddlEspecialidad.ClientID %>").on("change", function () {
                validarSelect(this, "#errorEspecialidad", "Seleccione una especialidad.");
            });
